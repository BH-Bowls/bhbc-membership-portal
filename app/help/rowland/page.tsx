    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          {/* Your next match */}
          <Section title="1. Your next match &amp; opponent contacts">
            ...
            <p className="text-sm text-gray-700 font-medium mb-2">If you are logged in as a BHBC player:</p>
            <p className="text-sm text-gray-700 leading-relaxed mb-3">
            ...
            <Note>
              Contact details shown here come from the Contacts sheet. If a club's Organiser or Skip details are missing or out of date, a BHBC Admin can update them. See section 5 below.
            </Note>
          </Section>
          ...
          <Section title="3. Managing results">
            <Note>
              Rowland administrators can enter or correct results for any match. RowlandPlayers and Captains can enter results for their own matches only.
            </Note>
            <Step n={1}>
          ...
          <Section title="5. Updating club contact details">
            <p className="text-sm text-gray-700 leading-relaxed mb-3">
            ...
            <Step n={1}>
              Go to <strong>Clubs</strong> and find the club.
            </Step>
            <Step n={2}>
          ...
          <Section title="6. Reviewing submitted results">
            <p className="text-sm text-gray-700 leading-relaxed">
              RowlandPlayers and Captains enter results and player names for their own matches. You can review all submissions in the draw. If a result looks incorrect, tap the match to open it and make corrections — your changes will overwrite what was submitted.
            </p>
          </Section>
