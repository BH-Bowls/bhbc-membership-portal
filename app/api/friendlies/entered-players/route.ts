// app/api/friendlies/entered-players/route.ts
// API endpoint to get list of players who have entered a game
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('[Friendlies API] Error fetching entered players:', error);
