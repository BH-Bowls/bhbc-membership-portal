...
// POST { draftSeasonId, method? }: carry the active season's Event-type
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runFixtureProjection(draftSeasonId, 'Event', method as ProjectionMethod | undefined);
