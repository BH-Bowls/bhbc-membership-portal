      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="px-4 py-3 bg-gray-50 border-t border-gray-200">
            <button
              onClick={addRow}
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-blue-900 bg-blue-100 rounded-md hover:bg-blue-50"
            >
        ...
        <div className="mt-6 flex justify-end space-x-3">
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="px-6 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 disabled:opacity-50"
          >
